  ...
  return (
    <>
      <Head>
        ...
        <meta name="image" content={relations?.attributes?.cover_image.data ? 'http://91.184.31.135:1338' + relations.attributes.cover_image.data.attributes.url : 'http://91.184.31.135:1338' + global.attributes.image.data.attributes.url} />
        <meta property="og:image" content={relations?.attributes?.cover_image?.data ? 'http://91.184.31.135:1338' + relations.attributes.cover_image.data.attributes.url : 'http://91.184.31.135:1338' + global.attributes.image.data.attributes.url} />
      </Head>
